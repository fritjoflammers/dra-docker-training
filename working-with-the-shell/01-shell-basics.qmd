...
The first column indicates the type of the file or directory and the permissions.
In the second column, you can see the number of links to the file or directory.
The third and fourth columns show the owner and group of the file or directory.
The fifth column shows the size of the file or directory.
The sixth column shows the date and time the file or directory was last modified.
